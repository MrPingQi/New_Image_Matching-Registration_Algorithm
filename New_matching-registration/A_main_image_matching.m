...
%     figure,imshow(I1_s); hold on; plot(keypoints_1(:,1)/resample1,keypoints_1(:,2)/resample1,'r+'); pause(0.01)
...
%     figure,imshow(I2_s); hold on; plot(keypoints_2(:,1)/resample2,keypoints_2(:,2)/resample2,'r+'); pause(0.01)
